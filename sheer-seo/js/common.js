...
(function($){
  ...
  var casesSlider = new Swiper('#cases__slider', {
    ...
    watchOverflow: true,
    navigation: {
      nextEl: '.cases__slider-wrap .swiper-button-next',
      prevEl: '.cases__slider-wrap .swiper-button-prev',
    },
    pagination: {
      el: '.cases__slider-wrap .swiper-dots',
    },
    breakpoints: {
      400: {
        slidesPerView: 2
    ...
    on: {
      init: function () {
        $(window).on("load", function () {
          $('#cases__slider .swiper-slide').each(function() {
            if ($(this).css('marginTop') == '60px') {
  ...
  $('.burger').click(function(){
    if ($(this).hasClass('burger--active')) {
      ...
      $('.cases__filter').removeClass('active');
      $('.cases__filter-btn').removeClass('active');
    } else {
  ...
  $('.cases__filter-btn').click(function() {
    $(this).addClass('active');
    $('.cases__filter').addClass('active');
    $('.cases__filter .burger').addClass('burger--active');
  });
